class ApiEndpoints {
  ...
  // Authentication
  static const String loginAuth = 'https://demo.eaccount.kyta.fpt.com/auth/login';
  static const String loginEmail = 'https://demo.eaccount.kyta.fpt.com/services/uaa/api/p/customer-logins/email';
  ...
  static String s3ResourceWithPagination({int pageOffset = 1, int pageSize = 20}) {
    return '$s3Resource?pageOffset=$pageOffset&pageSize=$pageSize';
  }
  
  static String s3ResourceTabWithPagination({int pageOffset = 1, int pageSize = 30}) {
